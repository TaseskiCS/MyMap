...
export default function Custom404() {
    return(
        ...
        <div className="w-auto max-w-3xl bg-white rounded-xl m-auto my-20 pb-10 text-black text-center">
            ...
            <p className="font-mono text-xl md:text-2xl py-5 md:py-10">Sorry, this page does not exist!</p>            
            <Link href="/" className="bg-green-400 py-2 px-4 rounded-md text-2xl hover:bg-zinc-800 hover:text-white transition-all duration-300" style={{fontFamily:"poppins", fontWeight:"500"}}>Go to Homepage</Link>
        </div>
        </>
    )
}